...
import type { ProviderHookRule, ProviderHooksInfo } from '@claude-control/contracts';
...
import { nextRowId, stableDraft } from './ProviderHooks.types';
...
function toRow(rule: ProviderHookRule): RuleRow {
  return {
    id: nextRowId(),
    event: rule.event,
 ...
 */
function toDraft(row: RuleRow, supportsMatcher: boolean): ProviderHookRule | undefined {
...
export function ProviderHookRulesEditor({
  data,
  projectId,
}: {
