import type { ProjectCodeLayout, ProjectCodeView } from '@agentdeck/contracts';
import { PROJECT_CODE_TREE_DEFAULT, clampTreeWidth } from '@agentdeck/contracts/project-code';
