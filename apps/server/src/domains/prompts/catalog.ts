...
export const PROMPT_CATALOG: readonly PromptCatalogEntry[] = [
  ...
  },
  {
    id: 'contour-agent',
    version: 1,
    usedBy: 'прогон агента через контур: заменяет системный промпт CLI, преамбула едет следом',
  },
  {
    id: 'contour-preamble',
    ...
    usedBy:
      'прогон агента через контур: дописывается к промпту агента; с выключенным коротким ' +
      'промптом контура не уезжает',
  },
  {
    id: 'image',
    version: 2,
    ...
    usedBy:
      'режим картинки: системное сообщение рисующей модели (дорога «частью ответа»); ' +
  ...
  },
  {
    ...
    usedBy: 'режим картинки, дорога агента: правила рисунка кодом (SVG) для любого CLI',
  },
  {
    id: 'presentation',
    version: 2,
    ...
    usedBy: 'режим презентации: тема → структура колоды (все дороги)',
  },
];
