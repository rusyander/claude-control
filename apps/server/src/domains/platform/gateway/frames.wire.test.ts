 ...
 * 1.93 (им платформа компании ходит к модели), модуль моделей платформы компании и
 ...
 * (`CustomStreamWrapper.model_response_creator`), а платформа компании пересылает его
 * как есть.
 */
const LITELLM_USAGE = {
  id: 'chatcmpl-1',
...
describe('хвост ответа после причины остановки (гейт проверок вывода)', () => {
  // На стороне контура придержанный гейтом хвост и хвост деанонимизатора
