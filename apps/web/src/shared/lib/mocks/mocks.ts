...
export const mockChats: ChatSummary[] = [
  {
    ...
    project: 'C--work-agentdeck',
    projectPath: 'C:\\work\\agentdeck',
    isSandbox: false,
    messageCount: 170,
  ...
  },
  {
    ...
    project: 'agentdeck-chats-new',
    projectPath: 'C:\\Users\\rusyander\\.agentdeck\\chats\\new-1784455113488',
    isSandbox: true,
    messageCount: 8,
    createdAt: ago(DAY),
    updatedAt: ago(DAY),
...
export const mockArtifacts: Artifact[] = [
  {
    name: 'page.html',
    path: 'C:\\Users\\rusyander\\.agentdeck\\chats\\new-1784455113488\\page.html',
    kind: 'html',
    sizeBytes: 8_421,
