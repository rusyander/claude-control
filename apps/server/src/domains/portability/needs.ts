 ...
 *     Этот уровень СЕГОДНЯ НЕДОСТИЖИМ: у пробы нет вызывающего (её половина
 *     снята с П0.2 и отложена до П2), и `observed` ниже срабатывает только на
 *     подставленных наблюдениях в тестах.
 *
