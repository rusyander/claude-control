...
- **A skill folder is put back by hand.** The restore button covers configuration files; the copy of a deleted skill sits in `agentdeck/backups`, but returning it is a manual job.
