...
| `~/.claude.json`                                                  | чтение / запись   | MCP-серверы и аккаунт — _рядом_ с домашним `.claude`; у каталога, заданного `CLAUDE_CONFIG_DIR` или в настройках, — **внутри** него, там же его ищет сам CLI |
