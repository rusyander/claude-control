...
- **Папку скилла из копии возвращают руками.** Кнопка отката работает с файлами конфигурации; копия удалённого скилла лежит в `agentdeck/backups`, но кладут её на место самостоятельно.
