    ...
    <>
      ...
      */}
      ...
      {/*
        ...
        строка объясняет, почему лента без пузыря всё же «работает» и что карточки
        прав живы. Про продолжения она молчит: на конце прогона сервер дочитывает
        ответ из транскрипта, и они заводятся как у обычного прогона.
      */}
