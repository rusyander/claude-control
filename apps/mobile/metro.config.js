 ...
 * поддерживаемых вложений, два разбора предложений панели (разделение задач и
 * продолжение в чистой сессии) и разбор тест-кейсов. Каждый самодостаточен — ни
 * одного импорта, это условие записано в самих файлах ради сервера, — поэтому
 * резолвится напрямую в исходник и не тянет за собой zod. Бочку
