...
export interface ChatMessagesProps {
   ...
   */
  onContinue?: () => void;
  /** Закрыть карточку ошибки и отменить упавший запрос — ни повтора, ни продолжения. */
  onDismissError?: () => void;
  /** Контекст переполнен: сжать его командой CLI `/compact`. */
  onCompact?: () => void;
  /** Контекст переполнен: продолжить в свежей сессии (родитель разделения уносит группы). */
  onFreshSession?: () => void;
