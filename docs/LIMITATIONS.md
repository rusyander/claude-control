...
| Project git has no `push`, `pull`, `merge` or branch deletion                 | **by design.** The panel is not a git client; it does exactly what you need while an agent works in the repository: branch, switch, new branch, commit       |
