...
1. `~/.agentdeck/credentials.json` — заданное вручную (перебивает всё)
...
`~/.claude/agentdeck/backups/`. Не трогай конфигурацию пользователя
...
**Витрина компонентов:** `pnpm --filter @agentdeck/web storybook`
