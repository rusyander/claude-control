 ...
 * написано.
 *
 * К КОНТУРУ ПАНЕЛЬ САМА НЕ ХОДИТ НИКОГДА — только по кнопке. Это правило Т1, и
...
async function platformCatalog(
  ...
  // Кнопка «Обновить» — единственный повод сходить к контуру. Проба бесплатна
  // (только список моделей), но след в журнале контура она всё равно оставляет.
  //
