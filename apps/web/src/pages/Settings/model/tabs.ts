...
export const SETTINGS_TABS = [
  ...
  { id: 'models', icon: 'link' },
  // Промпты стоят сразу за моделями: это вторая половина одного вопроса — «чем
  // и какими словами панель разговаривает с моделью».
  { id: 'prompts', icon: 'commands' },
  // Группы разделения — там же, где «чем и как панель ведёт агента»: что группа
  // решает сама и сколько их идёт разом.
  { id: 'groups', icon: 'branch' },
