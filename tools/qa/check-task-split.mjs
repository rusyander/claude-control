...
// Конвейер добавляет прогоны, а не агентов: одна понижённая группа из двух —
// это работа, ревью и правки, то есть до четырёх прогонов на две группы. Число
// обязано стоять ДО кнопки: столько панель заведёт сама, не спрашивая.
check(body.includes('до 4 прогонов с проверками'), 'конвейер назван до кнопки, вместе с ценой');
