...
| A deleted skill cannot be brought back with a button      | **not yet.** A copy of the folder is in `agentdeck/backups`, but restore only knows how to return configuration files |
