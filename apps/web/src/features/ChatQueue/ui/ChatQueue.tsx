 ...
 *
 * Полоска стоит над полем ввода — там же, где человек набирал: отсюда удобнее
 * всего передумать, и здесь же видно, сколько всего накопилось. Сами сообщения
 * показывает и лента, пузырём-призраком (`QueuedBubbles`), — но пунктиром и
 * приглушённо, чтобы очередь не выглядела уже отправленной.
 */
