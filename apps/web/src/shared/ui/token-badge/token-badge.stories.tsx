    ...
    docs: {
      description: {
        component:
          ...
          'Третий столбик — время шага: от предыдущей записи прогона до этой. ' +
          'У последней записи прогона рядом стоит его сумма (Σ). Записи без ' +
          'времени столбика не получают: пустое место честнее нуля.',
      },
    },
  },
  args: {
    ...
    durationMs: 72_000,
    from: '2026-09-09T10:00:04.000Z',
    to: '2026-09-09T10:01:16.000Z',
  },
  argTypes: {
...
/** Последняя запись прогона: рядом с шагом — сумма всего прогона. */
export const ИтогПрогона: Story = {
  args: { durationMs: 4200, runTotalMs: 160_000, to: '2026-09-09T10:02:40.000Z' },
};

/** Старая запись без времени: столбика нет, а не «0с». */
export const БезВремени: Story = {
  args: { durationMs: undefined, from: undefined, to: undefined },
};
