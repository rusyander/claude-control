 ...
 *              платформы компании и три стрелки, которые переходят границу между ними.
 ...
 * платформы компании, а не придуманные для картинки. Это важно ровно по той же причине,
...
heading(
  ...
  'Слева — всё, что происходит на вашей машине. Справа — сервисы инстанса платформы компании. Границу переходят три стрелки, и ни одна из них не ведёт в обратную сторону сама.',
  1160,
);
...
const zonePanel = column(
  ...
  [
    ...
    {
      id: 'p3:driver',
      title: 'Реестр контуров и драйвер платформы',
      lines: [
...
const zoneContour = column(
  ...
  P3_B_X,
  'Контур компании',
  'инстанс платформы компании, развёрнутый у вас',
  [
    {
      id: 'p3:ui',
      title: 'Админка установки',
      lines: [
    ...
    {
      id: 'p3:admin',
      title: 'Модели, ключи, учёт',
      lines: [
        'Держит каталог моделей и ключи, принимает расход от вызова модели. Именно его список видит проба панели — суженный правами вашего ключа.',
      ],
    },
    {
      id: 'p3:llm',
    ...
    {
      id: 'p3:boxes',
      title: 'Проверки, знания и агенты',
      lines: [
...
legend(p3, 60, bottomOf(p3) + 60, [
  ...
  { caption: 'сторона контура: инстанс платформы компании', stage: C.edge },
