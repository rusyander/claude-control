...
const GIT_OUTPUT = [
  ...
  ' create mode 100644 service-api/internal/store/teams_test.go',
  ' create mode 100644 module-agents/src/agents/logging_safe.py',
  ' create mode 100644 module-agents/tests/test_agent_from_definition.py',
  ' create mode 100644 module-agents/tests/test_coordinator_worker.py',
  ' create mode 100644 module-agents/tests/test_runs_coordinator_endpoint.py',
