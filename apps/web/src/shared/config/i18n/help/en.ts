  ...
  topics: {
    ...
    skills: {
      ...
      noteDeleteText:
        ...
        'agentdeck/backups — as it is for rules and hooks. You can bring it back ' +
    ...
    rules: {
      ...
      noteDeleteText:
        'A copy of the file stays in agentdeck/backups, but the rule will be ' +
    ...
    claudeMd: {
      ...
      recipe3: 'Save',
      recipe3Text:
        'A backup copy is created in ~/.claude/agentdeck/backups/ before the write. ' +
      ...
      noteBackupText:
        ...
        '~/.claude/agentdeck/backups/ and are rolled back from Settings — that is the ' +
